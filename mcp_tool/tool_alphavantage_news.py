...
from tools.a_stock_data_tools import get_config_value
...
# TODO
@mcp.tool()
def get_astock_news(symbol: str, limit: int = 10) -> str:
    """
    获取A股个股新闻和公告
    ...
    url = f"http://push2ex.eastmoney.com/api/qt/kinetics/get"
    params = {
        "lmt": limit,
        "fields1": "f1,f2,f3,f4,f5,f6",
        "fields2": "f51,f52,f53,f54,f55,f56,f57,f58,f59,f60,f61,f62,f63",
        "secid": f"0.{stock_code}" if symbol.endswith(".SZ") else f"1.{stock_code}"
    }
    ...
    try:
        ...
        return "\n".join(news_list) if news_list else "未找到相关新闻"
    except Exception as e:
        return f"获取新闻失败: {e}"
...
if __name__ == "__main__":
    ...
    port = int(os.getenv("SEARCH_HTTP_PORT", "8004"))
